function [all_finish_old_and_first_new,end_point3,vcpu_endpoint3] = find_all_finish_old_and_first_new(nr_vcpu,vcpu,ms,deadline,finish_old,mode,new_mode,old_mode,mcr,vcpu_type)
    ...
    for i=1:nr_vcpu
        ...
        if (strcmp(vcpu_type(i),'old') ~= 1) %skip for old vcpus.
            ...
            all_finish_old_and_first_new(i) = finish_old(i);
