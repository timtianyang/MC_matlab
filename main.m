...
while testNum<totalTest
    ...
    if (benchmark_only==0)
        ...
        total_job_misses=total_job_misses+jobs_miss_in_mc;
        total_job_during_mc=total_job_during_mc+jobs_in_mc;
...
if ( benchmark_only == 0)
    ...
    miss_ratio=total_job_misses/total_job_during_mc
